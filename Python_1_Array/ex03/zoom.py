...
def ft_zoom(path: str) -> np.ndarray:
    ...
    This function loads an image, converts it to grayscale (1 channel),
    slices it to a new width and height, and displays it using Matplotlib.
    ...
    print(f"New shape after slicing: ({height}, {width}, {num_channels}) or ({height}, {width})")
    # print(im_array_sliced) # RGB
